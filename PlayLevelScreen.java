...
//    public static Camera cam;
    ...
    protected SpriteFont fullScreen;
    ...
    public PlayLevelScreen(ScreenCoordinator screenCoordinator, GameWindow gameWindow, MusicData musicData) {
        ...
        fullScreen = new SpriteFont("Full Screen ", 470, 410, "Comic Sans", 30, new Color(49, 207, 240));
        fullScreen.setOutlineColor(Color.black);
        fullScreen.setOutlineThickness(3);
    }
    ...
    public void update() {
        ...
        if (isGamePaused == true) {
            ...
            } else if (currentSettingLevelHovered < 2) {
                currentSettingLevelHovered = 2;
            }
            //if (currentSettingLevelHovered > 3) {
            //    currentSettingLevelHovered = 0;
            //} else if (currentSettingLevelHovered < 0) {
            //    currentSettingLevelHovered = 3;
            // }
            ...
            if (settingsMenuItemSelected == 1 && settingsActive == true) {
                ...
                fullScreen.setColor(new Color(49, 207, 240));
                ...
                if (currentSettingLevelHovered == 3) {
                    ...
                    mediumScreen.setColor(new Color(49, 207, 240));
                    bigScreen.setColor(new Color(49, 207, 240));
                    fullScreen.setColor(new Color(255, 215, 0));
    ...
    public void setScreenFull() {
        ...
        //added
        config.WIDTHS = screenSize.width ;
        config.HEIGHTS = screenSize.height;

        Camera.setMultiplyInt(550);
        gameWindow.paintWindow();
