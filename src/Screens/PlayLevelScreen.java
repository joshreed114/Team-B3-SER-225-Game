...
public class PlayLevelScreen extends Screen implements PlayerListener {
	...
	public PlayLevelScreen(ScreenCoordinator screenCoordinator, GameWindow gameWindow, MusicData musicData) {
		...
		// Settings Buttons
		// Sound Settings
		volumeLevel = new SpriteFont("Volume: ", 490, 150, "Comic Sans", 30, new Color(49, 207, 240));
		volumeLevel.setOutlineColor(Color.black);
		volumeLevel.setOutlineThickness(3);

		// changed vol settings to off, low, full

		offVol = new SpriteFont("Off ", 370, 200, "Comic Sans", 30, new Color(49, 207, 240));
		offVol.setOutlineColor(Color.black);
		offVol.setOutlineThickness(3);
		lowVol = new SpriteFont("Low ", 500, 200, "Comic Sans", 30, new Color(49, 207, 240));
		lowVol.setOutlineColor(Color.black);
		lowVol.setOutlineThickness(3);
		HighVol = new SpriteFont("Full ", 670, 200, "Comic Sans", 30, new Color(49, 207, 240));
		HighVol.setOutlineColor(Color.black);
		HighVol.setOutlineThickness(3);
		// Aspect Ratio Settings
		aspectRatioLevel = new SpriteFont("Aspect Ratio: ", 470, 260, "Comic Sans", 30, new Color(49, 207, 240));
		aspectRatioLevel.setOutlineColor(Color.black);
		aspectRatioLevel.setOutlineThickness(3);
		smallScreen = new SpriteFont("Small ", 360, 310, "Comic Sans", 30, new Color(49, 207, 240));
		smallScreen.setOutlineColor(Color.black);
		smallScreen.setOutlineThickness(3);
		mediumScreen = new SpriteFont("Medium ", 490, 310, "Comic Sans", 30, new Color(49, 207, 240));
		mediumScreen.setOutlineColor(Color.black);
		mediumScreen.setOutlineThickness(3);
		bigScreen = new SpriteFont("Large ", 660, 310, "Comic Sans", 30, new Color(49, 207, 240));
		bigScreen.setOutlineColor(Color.black);
		bigScreen.setOutlineThickness(3);

		// music options

		MusicOptions = new SpriteFont("Music Options: ", 430, 380, "Comic Sans", 30, new Color(49, 207, 240));
		MusicOptions.setOutlineColor(Color.black);
		MusicOptions.setOutlineThickness(3);

		dragonBallZ = new SpriteFont("DragonBallZ ", 270, 425, "Comic Sans", 30, new Color(49, 207, 240));
		dragonBallZ.setOutlineColor(Color.black);
		dragonBallZ.setOutlineThickness(3);
		classic = new SpriteFont("Classic ", 500, 425, "Comic Sans", 30, new Color(49, 207, 240));
		...
		*/
		...
		WASD = new SpriteFont("WASD ", 580, 515, "Comic Sans", 30, new Color(49, 207, 240));
		WASD.setOutlineColor(Color.black);
		WASD.setOutlineThickness(3);
	}
	...
	public void update() {
		...
		if (isGamePaused == true) {
			...
			if (settingsMenuItemSelected == 0 && settingsActive == true) {
				...
				if (currentSettingLevelHovered == 1) {
					ArrowKeys.setColor(new Color(49, 207, 240));
					WASD.setColor(new Color(255, 215, 0));
