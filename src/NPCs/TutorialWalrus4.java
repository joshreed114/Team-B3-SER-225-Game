...
public class TutorialWalrus4 extends NPC {

	public TutorialWalrus4(Point location, Map map) {
	...
	protected SpriteFont createMessage() {
		return new SpriteFont("Jump on that box to finish. Good Luck!", getX(), getY() - 10, "Arial", 12, Color.BLACK);
	}
	...
	public void drawMessage(GraphicsHandler graphicsHandler) {
		...
		graphicsHandler.drawFilledRectangleWithBorder(Math.round(getCalibratedXLocation() - 2),
				Math.round(getCalibratedYLocation() - 24), 220, 25, Color.WHITE, Color.BLACK, 2);
