...
public class TutorialWalrus3 extends NPC {

	public TutorialWalrus3(Point location, Map map) {
	...
	protected SpriteFont createMessage() {
		return new SpriteFont("That over there is a coin! Go grab it!", getX(), getY() - 10, "Arial", 12, Color.BLACK);
	}
