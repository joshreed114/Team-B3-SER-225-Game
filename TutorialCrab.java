...
public class TutorialCrab extends NPC {

	public TutorialCrab(Point location, Map map) {
	...
	protected SpriteFont createMessage() {
		return new SpriteFont("Jump up over the tree!", getX(), getY() - 10, "Arial", 12, Color.BLACK);
	}
